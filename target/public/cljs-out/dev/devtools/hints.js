...
var column = cljs.core.get.call(null,map__15266__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e15265){var _e = e15265;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___15268 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___15268)){
var seen_errors_15269 = temp__5455__auto___15268;
if(cljs.core.truth_(seen_errors_15269.has(self))){
} else {
seen_errors_15269.add(self);

var temp__5457__auto___15270 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___15270)){
var sense_15271 = temp__5457__auto___15270;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_15271)].join('');
} else {
}
}
} else {
