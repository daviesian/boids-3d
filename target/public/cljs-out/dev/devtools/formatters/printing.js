...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq9170){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__9171,G__9172,seq9170__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__9176_SHARP_){
return !((cljs.core.meta.call(null,p1__9176_SHARP_) == null));
})))){
...
var map__9177 = opts;
var map__9177__$1 = ((((!((map__9177 == null)))?(((((map__9177.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__9177.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__9177):map__9177);
var markup_db = cljs.core.get.call(null,map__9177__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e9181){var _e__8130__auto__ = e9181;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e9183){var _e__8130__auto__ = e9183;
return false;
}}
})())){
...
var _STAR_current_state_STAR_9185 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__9186 = opts;
...
var markup_db = cljs.core.get.call(null,map__9186__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_9185;
}});
...
;
var temp__5455__auto___9190 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___9190)){
var managed_print_level_9191 = temp__5455__auto___9190;
var _STAR_print_level_STAR_9189_9192 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_9191;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_9189_9192,managed_print_level_9191,temp__5455__auto___9190,writer,opts,job_fn){
return (function (p1__9188_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__9188_SHARP_,null);
});})(_STAR_print_level_STAR_9189_9192,managed_print_level_9191,temp__5455__auto___9190,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_9189_9192;
}} else {
job_fn.call(null);
}
