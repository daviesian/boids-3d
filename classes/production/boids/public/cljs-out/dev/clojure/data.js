...
return cljs.core.reduce.call(null,(function (result,p__10383){
...
var vec__10387 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__10387,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__10387,(1),null);
var ab = cljs.core.nth.call(null,vec__10387,(2),null);
...
return (function (){var G__10396 = clojure.data.equality_partition.call(null,a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10396__$1)].join('')));
